...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-6 py-12 lg:px-12 xl:px-20">
        <div className="mx-auto w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="w-full h-11 rounded-lg" variant="default">
              Sign in →
            </Button>
          </form>
      ...
      <div className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-primary/10 via-primary/5 to-background px-12 xl:px-20">
