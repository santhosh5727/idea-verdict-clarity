...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 px-12 xl:px-20">
        <div className="mx-auto max-w-lg">
          {/* Logo */}
          <div className="mb-8 flex flex-col items-center">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary">
              <span className="text-2xl font-bold text-primary-foreground">IV</span>
            </div>
            <h2 className="text-2xl font-bold text-foreground">Idea Verdict</h2>
            <p className="mt-1 text-muted-foreground">Know if your startup idea deserves to exist</p>
          </div>
